class juego {
  ...
  dibujar() {
    ...
    image(this.imagenes.fondo, -300, this.fondoy)
   ...
   if (this.fondoy > -5000) {
    ...
    for (let i = 0; i < 6; i++) {
     ...
     this.dragon.dibujar();
     image(this.imagenes.corazon,450, 50);
    image(this.imagenes.corazon, 500, 50);
    image(this.imagenes.corazon, 550, 50);
     if (this.contador>=1){
     image(this.imagenes.cruz,440,40,50,50);
   }
        if (this.contador>=2){
     image(this.imagenes.cruz,490,40,50,50);
        }
