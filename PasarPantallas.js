...
constructor (){
 ...
 this.juego= new juego(5);
   this.imgdragon= loadImage('data/imgdragon.png');
    this.imgpelea= loadImage('data/imgpelea.png');
    this.imgvillano= loadImage('data/imgvillano.png');
...
break;
 ...
 case 10:
  ...
  break;
   ...
   case 14:
  background(0, 0, 255);
  image(this.imgvillano, 0, 0,width,height);
  this.boton(530, 530, 70);
  textSize (15);
